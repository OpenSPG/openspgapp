...
public interface ProjectMemberRoleInfoMapper {
   ...
   */
  List<ProjectMemberRoleInfoDO> selectByCondition(
      @Param("record") ProjectMemberRoleInfoDO record,
  ...
  int deleteByProjectIdAndUserId(
      @Param("userNo") String userNo, @Param("projectId") long projectId);
   ...
   * @return
   */
  List<ProjectMemberRoleInfoDO> selectAllByCondition(
      @Param("record") ProjectMemberRoleInfoDO kgProjectMemberRoleInfoDO);
  ...
  List<ProjectMemberRoleInfoDO> selectMemberWithFilter(
  ...
  int selectMemberCountWithFilter(
      @Param("projectId") long projectId,
      @Param("filter") String filter,
      @Param("roleId") Long roleId);

  List<ProjectMemberRoleInfoDO> selectByProjectIdAndUserNo(
      @Param("projectId") long projectId, @Param("userNo") String userNo);
