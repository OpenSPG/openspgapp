...
public interface UserResourceRoleMapper {
   ...
   */
  List<UserResourceRoleDO> selectByCondition(
      @Param("record") UserResourceRoleDO record,
   ...
   * @return
   */
  UserResourceRoleDO selectUserTypeRoleForUpdate(
   ...
   * @return
   */
  List<UserResourceRoleDO> selectByRoleId(
   ...
   * @return
   */
  List<UserResourceRoleDO> selectByResources(
   ...
   * @return
   */
  List<UserResourceRoleDO> getResourceIdByUserNoAndRoleName(
      @Param("userNo") String userNo,
      @Param("resourceTag") String resourceTag,
   ...
   * @return
   */
  List<UserResourceRoleDO> getByResourceIds(
